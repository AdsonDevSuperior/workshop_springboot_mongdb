...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2023"), "Partiu viagem", "Vou viajar pra São Paulo. abraços", maria);

		Post post2 = new Post(null, sdf.parse("23/03/2023"), "Bom dia", "Acorde feliz hoje!", maria);
